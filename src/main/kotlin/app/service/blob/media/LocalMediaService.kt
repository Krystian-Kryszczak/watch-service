...
abstract class LocalMediaService(private val containerName: String): MediaService {
    ...
    private fun getStorageContainer(): File {
        var storageDir = this.storageDir
    ...
    override fun save(id: UUID, fileUpload: StreamingFileUpload, creatorId: UUID, private: Boolean): Single<Boolean> = Single.just(
        File(storageContainer, id.toString())
    )
        .flatMap {
